...
{   //Считывает только публичные поля, лучше использовать какой-нибудь атрибут
    public partial class TableDataService<T>
    {
        ...
        public TableDataService()
        {
            ...
            _connectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\АбдигалиевМ.CORP.000\Source\Repos\20190401_PizzaApp\PizzaApp\PizzaAppDataAccess\PizaApdb.mdf;Integrated Security=True";
